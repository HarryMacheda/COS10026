...
function ApplicantEmail($applicantID, $listingId){
    ...
    $message = ApplicantEmailText($ApplicantFirstName, $ApplicantLastName, $JobTitle);
...
function ApplicantEmailText($firstname, $surname, $JobTitle) {
    $message = "";
    ...
    ."<p style=\"color:#DD9DAD;font-size: 50px;padding:20px;\">You will here back from us shortly :)</p>"
